        ...
        <div className="to-read-wrapper">
            ...
            <div className="reading-status-bar">
                <button className="status-button" onClick={() => navigate('/reading')}>
                    <div className="icon-wrapper" style={{ backgroundColor: '#F7EE46' }}>
                ...
                <button className="status-button active" onClick={() => navigate('/to-read')}>
                    <div className="icon-wrapper" style={{ backgroundColor: '#F4B6FF' }}>
                ...
                <button className="status-button" onClick={() => navigate('/read')}>
                    <div className="icon-wrapper" style={{ backgroundColor: '#86CD68' }}>
            ...
            <div className="book-list">
                <div className="book-item"><img src="/images/Book1.jpg" alt="책 1" /></div>
                <div className="book-item"><img src="/images/Book2.jpg" alt="책 2" /></div>
                <div className="book-item"><img src="/images/Book3.jpg" alt="책 3" /></div>
            </div>
